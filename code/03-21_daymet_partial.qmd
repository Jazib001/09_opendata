...
```{r}
field = read.csv("../data/fielddata.csv")
...
daymet_all = download_daymet(site = field$site[[1]],
                             lat = field$lat[[1]],
                             lon = field$lon[[1]],
                             start = field$year[[1]],
                             end = field$year[[1]],
...
# weather data for all sites and years 
```{r}
daymet_all = field %>%
  mutate(weather = pmap(list(.y = year,
                             .site = site,
